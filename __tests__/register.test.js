...
describe('User Registration Test', () => {
  ...
  //   test('it should validate user input and return 400 if fields are missing');

  //   test('it should return 403 is a user with that email already exists');
...
// test('it should register a user without an image');
